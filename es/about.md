...
<div class="container">
  ...
  <div class="about-body">
    <p>Hola, soy Bernardo. Llevo dos décadas escribiendo software y usando LLMs en producción desde los tiempos de GPT-3. Este blog es donde guardo las cosas pequeñas y útiles que voy aprendiendo — notas cortas, fragmentos de código y alguna que otra reflexión.</p>
    <p>Actualmente trabajo en tooling de plataforma y experiencia de desarrollador. Antes, infraestructura backend en varias empresas que conoces.</p>

    <div class="about-grid">
      <div class="about-card">
        <div class="label">Ahora mismo</div>
        <div class="value">Tooling de plataforma y DX</div>
      </div>
      <div class="about-card">
        <div class="label">Basado en</div>
        <div class="value">Madrid, ES</div>
      </div>
      <div class="about-card">
        <div class="label">Escribiendo desde</div>
        <div class="value">2026</div>
      </div>
      <div class="about-card">
        <div class="label">Posts publicados</div>
        <div class="value">{{ site.posts | where: "lang", "es" | size }}</div>
      </div>
    </div>

    <p>La forma más rápida de contactarme es GitHub o Twitter.</p>
